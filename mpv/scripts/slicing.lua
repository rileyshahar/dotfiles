-- modified from https://github.com/Kagami/mpv_slicing/blob/master/slicing.lua
...
function cut(shift, endpos)
	...
	local outpath = escape(utils.join_path(o.target_dir:gsub("~", get_homedir()), get_outname(shift, endpos)))
...
function toggle_mark()
	local cut_pos = mp.get_property_number("ab-loop-a")
