...
ln -sv "$DOTFILES_DIR/nvim/init.lua" "$CONFIG_HOME/nvim"
ln -sv "$DOTFILES_DIR/nvim/lua/" "$CONFIG_HOME/nvim"
ln -sv "$DOTFILES_DIR/nvim/snippets/" "$CONFIG_HOME/nvim"
ln -sv "$DOTFILES_DIR/nvim/ftplugin/" "$CONFIG_HOME/nvim"
